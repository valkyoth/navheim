...
| Snapshot envelope, orthogonal authenticity/confidentiality, cryptographic lifecycle, platform protection and ordered profiles | v0.18.1-v0.18.2, v0.48.4, v0.54.2-v0.55.1, v0.144.3, v0.168.3 and v0.189.2-v0.189.6 |
...
| Borrow-safe Tier 2 execution, cooperative cancellation, unresponsive ownership and lossless traces | v0.48.3 |
| Prepared SDR configuration, generations, initialized-count reads and per-adapter conformance | v0.50.3 and v0.170.0-v0.174.0 |
