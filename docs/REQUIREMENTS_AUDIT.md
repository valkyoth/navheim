...
| Sound Tier 2 dispatch/cancel CAS, supervisor-enforced deterministic cleanup lanes and globally ordered grant/result replay, live-handle serialization, proved payload ownership, generation-safe reuse and fail-stop | v0.48.3 |
