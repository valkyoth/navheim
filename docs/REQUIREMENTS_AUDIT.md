...
| Snapshot envelope, narrow counter checks, canonical domain-separated transaction binding and platform protection | v0.18.1-v0.18.2, v0.48.4, v0.54.2-v0.55.1, v0.144.3, v0.168.3 and v0.189.2-v0.189.6 |
...
| Sound Tier 2 registry/lease ownership across lost handles, shutdown and fail-stop destruction | v0.48.3 |
| Prepared SDR configuration with proof/cause/evidence-carrying coherence outcomes and safe reads | v0.50.3 and v0.170.0-v0.174.0 |
