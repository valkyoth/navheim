...
| Sound Tier 2 dispatch/cancel CAS, live-handle-compatible serialized cleanup/backpressure, proved payload ownership, generation-safe reuse and fail-stop | v0.48.3 |
