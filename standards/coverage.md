...
| Persistent state protection | Orthogonal evidence, canonical domain-separated transaction binding, authority-clock reservations and separately admitted platform authorities | Planned; no universal keystore, implicit suite or rollback-resistance claim |
...
| SDR/accelerator I/O | Prepared plans, proof-carrying success/no-mutation, cause/evidence-carrying failures, coherent groups and safe reads for named stacks | Planned; device read-back and accelerator output remain assertions |
